...
public:
    ...
    CarbonColumnType GetType() const override { return CarbonColumnType::TABLE_COLUMN; }

    std::string ToString() const override {
        return "TableColumn(OID=" + std::to_string(table_oid_) +
               ", RT=" + std::to_string(rt_index_) + ", Attr=" + std::to_string(attr_num_) + ")";
    }
...
public:
    ...
    CarbonColumnType GetType() const override { return CarbonColumnType::EXPR_COLUMN; }
