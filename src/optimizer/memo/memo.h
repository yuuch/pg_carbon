...
public:
    ...
    const PgVector<GroupExpression *> &GetLogicalExpressions() const { return logical_exprs_; }
    const PgVector<GroupExpression *> &GetPhysicalExpressions() const { return physical_exprs_; }
    ...
    LogicalProperties *GetLogicalProperties() const { return logical_properties_; }
